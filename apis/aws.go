...
import (
	...
	certificateauthorityv1alpha1 "github.com/crossplane/provider-aws/apis/certificatemanager/v1alpha1"
...
func init() {
	...
	AddToSchemes = append(AddToSchemes,
		...
		certificateauthorityv1alpha1.SchemeBuilder.AddToScheme,
